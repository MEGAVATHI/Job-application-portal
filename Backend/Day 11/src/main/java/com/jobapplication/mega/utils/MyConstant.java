...
//     public static final String SWAGGER_INFO_CONTACT_NAME="Mega";
//     public static final String SWAGGER_INFO_CONTACT_EMAIL="727721eucs100@skcet.ac.in";
//     public static final String SWAGGER_INFO_CONTACT_URL="https://mega.com";
...
public class MyConstant {
    ...
    public static final String SWAGGER_INFO_VERSION = "1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME = "Megavathi";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "mega1211@gmail.com";
    public static final String SWAGGER_INFO_CONTACT_URL = "http://localhost:5173/landing";
